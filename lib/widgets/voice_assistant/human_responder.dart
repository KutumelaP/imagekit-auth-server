...
class HumanResponder {
  ...
  String _normalizeCategory(String raw) {
    final c = raw.trim();
    // Map common variants to canonical categories used in Firestore (best effort)
    switch (c) {
      case 'food':
      case 'foods':
      case 'groceries':
      ...
      case 'snacks':
        return 'Snacks';
      default:
        // Capitalize first letter only for general category guesses
        return c.isEmpty ? 'Stores' : c[0].toUpperCase() + c.substring(1);
    }
  }
